...
def test_apply_repr_html(v):
    ...
    assert repr_html(v.apply(unary.one)) == (
        "<div>"
        f"{CSS_STYLE}"
        '<details class="gb-expr-details"><summary class="gb-expr-summary"><tt><b>gb.VectorExpression</b></tt>&nbsp;<span class="expr-tooltip"><span class="tooltip-circle">?</span><span class="tooltip-text"><em>Do <code>expr.new()</code> or <code>other << expr</code> to calculate the expression.</em></span></span><div>\n'
        '<table class="gb-info-table">\n'
        "  <tr>\n"
...
def test_mxm_repr_html(A, B):
    ...
    assert repr_html(A.mxm(B)) == (
        "<div>"
        f"{CSS_STYLE}"
        '<details class="gb-expr-details"><summary class="gb-expr-summary"><tt><b>gb.MatrixExpression</b></tt>&nbsp;<span class="expr-tooltip"><span class="tooltip-circle">?</span><span class="tooltip-text"><em>Do <code>expr.new()</code> or <code>other << expr</code> to calculate the expression.</em></span></span><div>\n'
        '<table class="gb-info-table">\n'
        "  <tr>\n"
...
def test_matrix_reduce_repr_html(C, v):
    ...
    assert repr_html(C.reduce_scalar()) == (
        "<div>"
        f"{CSS_STYLE}"
        '<details class="gb-expr-details"><summary class="gb-expr-summary"><tt><b>gb.ScalarExpression</b></tt>&nbsp;<span class="expr-tooltip"><span class="tooltip-circle">?</span><span class="tooltip-text"><em>Do <code>expr.new()</code> or <code>other << expr</code> to calculate the expression.</em></span></span><div>\n'
        '<table class="gb-info-table">\n'
        "  <tr>\n"
...
def test_infix_expr_repr_html(A, B, v):
    ...
    assert repr_html(v & v) == (
        "<div>"
        f"{CSS_STYLE}"
        '<details class="gb-expr-details"><summary class="gb-expr-summary"><tt><b>gb.VectorEwiseMultExpr</b></tt>&nbsp;<span class="expr-tooltip"><span class="tooltip-circle">?</span><span class="tooltip-text"><em>Do <code>op(expr)</code> to create a <tt>VectorExpression</tt> for <tt>ewise_mult</tt>.<br>For example: <code>times(v & v)</code></em></span></span><div>\n'
        '<table class="gb-info-table">\n'
        "  <tr>\n"
    ...
    assert repr_html(v | v) == (
        "<div>"
        f"{CSS_STYLE}"
        '<details class="gb-expr-details"><summary class="gb-expr-summary"><tt><b>gb.VectorEwiseAddExpr</b></tt>&nbsp;<span class="expr-tooltip"><span class="tooltip-circle">?</span><span class="tooltip-text"><em>Do <code>op(expr)</code> to create a <tt>VectorExpression</tt> for <tt>ewise_add</tt>.<br>For example: <code>plus(v | v)</code></em></span></span><div>\n'
        '<table class="gb-info-table">\n'
        "  <tr>\n"
        '    <td rowspan="2" class="gb-info-name-cell"><pre>v | v</pre></td>\n'
        "    <td><pre>size</pre></td>\n"
    ...
    assert repr_html(A @ v) == (
        "<div>"
        f"{CSS_STYLE}"
        '<details class="gb-expr-details"><summary class="gb-expr-summary"><tt><b>gb.VectorMatMulExpr</b></tt>&nbsp;<span class="expr-tooltip"><span class="tooltip-circle">?</span><span class="tooltip-text"><em>Do <code>op(expr)</code> to create a <tt>VectorExpression</tt> for <tt>mxv</tt>.<br>For example: <code>plus_times(A<sub>1</sub> @ v)</code></em></span></span><div>\n'
        '<table class="gb-info-table">\n'
        "  <tr>\n"
    ...
    assert repr_html(v @ A.T) == (
        "<div>"
        f"{CSS_STYLE}"
        '<details class="gb-expr-details"><summary class="gb-expr-summary"><tt><b>gb.VectorMatMulExpr</b></tt>&nbsp;<span class="expr-tooltip"><span class="tooltip-circle">?</span><span class="tooltip-text"><em>Do <code>op(expr)</code> to create a <tt>VectorExpression</tt> for <tt>vxm</tt>.<br>For example: <code>plus_times(v @ A<sub>1</sub>.T)</code></em></span></span><div>\n'
        '<table class="gb-info-table">\n'
        "  <tr>\n"
    ...
    assert repr_html(A & B.T) == (
        "<div>"
        f"{CSS_STYLE}"
        '<details class="gb-expr-details"><summary class="gb-expr-summary"><tt><b>gb.MatrixEwiseMultExpr</b></tt>&nbsp;<span class="expr-tooltip"><span class="tooltip-circle">?</span><span class="tooltip-text"><em>Do <code>op(expr)</code> to create a <tt>MatrixExpression</tt> for <tt>ewise_mult</tt>.<br>For example: <code>times(A<sub>1</sub> & B<sub>1</sub>.T)</code></em></span></span><div>\n'
        '<table class="gb-info-table">\n'
        "  <tr>\n"
    ...
    assert repr_html(A | A) == (
        "<div>"
        f"{CSS_STYLE}"
        '<details class="gb-expr-details"><summary class="gb-expr-summary"><tt><b>gb.MatrixEwiseAddExpr</b></tt>&nbsp;<span class="expr-tooltip"><span class="tooltip-circle">?</span><span class="tooltip-text"><em>Do <code>op(expr)</code> to create a <tt>MatrixExpression</tt> for <tt>ewise_add</tt>.<br>For example: <code>plus(A<sub>1</sub> | A<sub>1</sub>)</code></em></span></span><div>\n'
        '<table class="gb-info-table">\n'
        "  <tr>\n"
    ...
    assert repr_html(A @ B) == (
        "<div>"
        f"{CSS_STYLE}"
        '<details class="gb-expr-details"><summary class="gb-expr-summary"><tt><b>gb.MatrixMatMulExpr</b></tt>&nbsp;<span class="expr-tooltip"><span class="tooltip-circle">?</span><span class="tooltip-text"><em>Do <code>op(expr)</code> to create a <tt>MatrixExpression</tt> for <tt>mxm</tt>.<br>For example: <code>plus_times(A<sub>1</sub> @ B<sub>1</sub>)</code></em></span></span><div>\n'
        '<table class="gb-info-table">\n'
        "  <tr>\n"
    ...
    assert repr_html(A.T @ B.T) == (
        "<div>"
        f"{CSS_STYLE}"
        '<details class="gb-expr-details"><summary class="gb-expr-summary"><tt><b>gb.MatrixMatMulExpr</b></tt>&nbsp;<span class="expr-tooltip"><span class="tooltip-circle">?</span><span class="tooltip-text"><em>Do <code>op(expr)</code> to create a <tt>MatrixExpression</tt> for <tt>mxm</tt>.<br>For example: <code>plus_times(A<sub>1</sub>.T @ B<sub>1</sub>.T)</code></em></span></span><div>\n'
        '<table class="gb-info-table">\n'
        "  <tr>\n"
    ...
    assert repr_html(v @ v) == (
        "<div>"
        f"{CSS_STYLE}"
        '<details class="gb-expr-details"><summary class="gb-expr-summary"><tt><b>gb.ScalarMatMulExpr</b></tt>&nbsp;<span class="expr-tooltip"><span class="tooltip-circle">?</span><span class="tooltip-text"><em>Do <code>op(expr)</code> to create a <tt>ScalarExpression</tt> for <tt>inner</tt>.<br>For example: <code>plus_times(v @ v)</code></em></span></span><div>\n'
        '<table class="gb-info-table">\n'
        "  <tr>\n"
        '    <td rowspan="2" class="gb-info-name-cell"><pre>v @ v</pre></td>\n'
        "    <td><pre>left_dtype</pre></td>\n"
...
def test_autocompute_html(A, B, v):
    ...
    assert repr_html(A & A) == (
        "<div>"
        f"{CSS_STYLE}"
        '<details class="gb-expr-details"><summary class="gb-expr-summary"><tt><b>gb.MatrixEwiseMultExpr</b></tt>&nbsp;<span class="expr-tooltip"><span class="tooltip-circle">?</span><span class="tooltip-text"><em>Do <code>op(expr)</code> to create a <tt>MatrixExpression</tt> for <tt>ewise_mult</tt>.<br>For example: <code>times(A<sub>1</sub> & A<sub>1</sub>)</code></em></span></span><div>\n'
        '<table class="gb-info-table">\n'
        "  <tr>\n"
        '    <td rowspan="2" class="gb-info-name-cell"><pre>A<sub>1</sub> & A<sub>1</sub></pre></td>\n'
        "    <td><pre>nrows</pre></td>\n"
    ...
    assert repr_html(BIG.ewise_add(small)) == (
        ...
        "</table>\n"
        "</div>\n"
        '</summary><span style="color: red">Result is too large to compute!</span></details></div>'
    )
    BIG_bool = BIG.dup(dtype=bool)
    small_bool = small.dup(dtype=bool)
    small_bool[0] = False
    ...
    assert repr_html(BIG_bool | small_bool) == (
        "<div>"
        f"{CSS_STYLE}"
        '<details class="gb-expr-details"><summary class="gb-expr-summary"><tt><b>gb.VectorEwiseAddExpr</b></tt>&nbsp;<span class="expr-tooltip"><span class="tooltip-circle">?</span><span class="tooltip-text"><em>Do <code>op(expr)</code> to create a <tt>VectorExpression</tt> for <tt>ewise_add</tt>.<br>For example: <code>plus(v<sub>6</sub> | v<sub>7</sub>)</code></em></span></span><div>\n'
        '<table class="gb-info-table">\n'
        "  <tr>\n"
    ...
    assert repr_html(C & C) == (
        "<div>"
        f"{CSS_STYLE}"
        '<details open class="gb-arg-details"><summary class="gb-arg-summary"><tt><b>gb.MatrixEwiseMultExpr</b></tt>&nbsp;<span class="expr-tooltip"><span class="tooltip-circle">?</span><span class="tooltip-text"><em>Do <code>op(expr)</code> to create a <tt>MatrixExpression</tt> for <tt>ewise_mult</tt>.<br>For example: <code>times(M<sub>2</sub> & M<sub>2</sub>)</code></em></span></span><div>\n'
        '<table class="gb-info-table">\n'
        "  <tr>\n"
...
def test_index_expr_vector_html(v):
    ...
    assert repr_html(v[0]) == (
        "<div>"
        f"{CSS_STYLE}"
        '<details class="gb-expr-details"><summary class="gb-expr-summary"><tt><b>gb.ScalarIndexExpr</b></tt>&nbsp;<span class="expr-tooltip"><span class="tooltip-circle">?</span><span class="tooltip-text"><em>This expression may be used to extract or assign a <tt>Scalar</tt>.<br>Example extract: <code>v[0].new()</code><br>Example assign: <code>v[0] << s</code></em></span></span><div>\n'
        '<table class="gb-info-table">\n'
        "  <tr>\n"
    ...
    assert repr_html(v[[0, 1]]) == (
        "<div>"
        f"{CSS_STYLE}"
        '<details class="gb-expr-details"><summary class="gb-expr-summary"><tt><b>gb.VectorIndexExpr</b></tt>&nbsp;<span class="expr-tooltip"><span class="tooltip-circle">?</span><span class="tooltip-text"><em>This expression may be used to extract or assign a <tt>Vector</tt>.<br>Example extract: <code>v[[0, 1]].new()</code><br>Example assign: <code>v[[0, 1]] << v</code></em></span></span><div>\n'
        '<table class="gb-info-table">\n'
        "  <tr>\n"
...
def test_index_expr_matrix_html(A):
    ...
    assert repr_html(A[0, 1]) == (
        "<div>"
        f"{CSS_STYLE}"
        '<details class="gb-expr-details"><summary class="gb-expr-summary"><tt><b>gb.ScalarIndexExpr</b></tt>&nbsp;<span class="expr-tooltip"><span class="tooltip-circle">?</span><span class="tooltip-text"><em>This expression may be used to extract or assign a <tt>Scalar</tt>.<br>Example extract: <code>A_1[0, 1].new()</code><br>Example assign: <code>A_1[0, 1] << s</code></em></span></span><div>\n'
        '<table class="gb-info-table">\n'
        "  <tr>\n"
        '    <td rowspan="2" class="gb-info-name-cell"><pre>A_1[0, 1]</pre></td>\n'
        "    <td><pre>dtype</pre></td>\n"
        "  </tr>\n"
        "  <tr>\n"
        "    <td>INT64</td>\n"
    ...
    assert repr_html(A[:2, [1, 2]]) == (
        "<div>"
        f"{CSS_STYLE}"
        '<details class="gb-expr-details"><summary class="gb-expr-summary"><tt><b>gb.MatrixIndexExpr</b></tt>&nbsp;<span class="expr-tooltip"><span class="tooltip-circle">?</span><span class="tooltip-text"><em>This expression may be used to extract or assign a <tt>Matrix</tt>.<br>Example extract: <code>A_1[:, [1, 2]].new()</code><br>Example assign: <code>A_1[:, [1, 2]] << M</code></em></span></span><div>\n'
        '<table class="gb-info-table">\n'
        "  <tr>\n"
        '    <td rowspan="2" class="gb-info-name-cell"><pre>A_1[:, [1, 2]]</pre></td>\n'
        "    <td><pre>nrows</pre></td>\n"
        "    <td><pre>ncols</pre></td>\n"
        "    <td><pre>dtype</pre></td>\n"
        "  </tr>\n"
...
def test_index_expr_autocompute(v):
    ...
    assert repr_html(v[[0, 1]]) == (
        "<div>"
        f"{CSS_STYLE}"
        '<details open class="gb-arg-details"><summary class="gb-arg-summary"><tt><b>gb.VectorIndexExpr</b></tt>&nbsp;<span class="expr-tooltip"><span class="tooltip-circle">?</span><span class="tooltip-text"><em>This expression may be used to extract or assign a <tt>Vector</tt>.<br>Example extract: <code>v[[0, 1]].new()</code><br>Example assign: <code>v[[0, 1]] << v</code></em></span></span><div>\n'
        '<table class="gb-info-table">\n'
        "  <tr>\n"
        '    <td rowspan="2" class="gb-info-name-cell"><pre>v[[0, 1]]</pre></td>\n'
        "    <td><pre>nvals</pre></td>\n"
